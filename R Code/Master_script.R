...
setwd("C:/Users/kyles/Desktop/Recent Advances on Estimating Population Size with Link-Tracing Sampling/R Code")
...
#Then apply a Gelman-Rubin test to determine if convergence has been met based on seeded reorderings that are "overdispersed"
##################################################################################################################################################################

#Apply the MCMC procedure to the selected sample
use_beta_est = TRUE #Set to TRUE to use the estimates from the GLM fit
num_mcmc = 250000 #The number of MCMC iterations per chain
...
MCMC(s=s, num_chains=num_chains, search_iterations=search_iterations, use_beta_est=use_beta_est, var_est=var_est, var_est_new=var_est_new)
...
#Search for overdispersed sample reorderings	
source("Search_overdispersed_reorderings.R")
search_iterations = 25000 #The number of search iterations to seed chain
Search_overdispersed_reorderings(s=s, search_iterations=search_iterations, use_beta_est=use_beta_est, var_est=var_est, var_est_new=var_est_new)
...
Gelman_Rubin(s.overdispersed.1=s.overdispersed.1, s.overdispersed.2=s.overdispersed.2, use_beta_est=use_beta_est, var_est=var_est, var_est_new=var_est_new)
...
var_est = "Seber" #Choose the variance type of estimator (must be "jack" or "Seber")
var_est_new = "Seber" #Choose the variance type of estimator (must be "jack" or "Seber")
num_mcmc = 600000 #The number of MCMC iterations per chain
...
seeds = 1396:1400 #Enter as "Time" or 1:num_sims
